...
| README uses "BM JMX Recorder" (stale) | High — confusing for users/testers |
...
Replace all "BM JMX Recorder" with "Capultura". Replace "Betamax" with "Capultura".
...
No stale references to SideeX, Betamax, BM JMX Recorder in published docs.
